...
var ExplorerLinks = &Links{
	...
	Github:          "https://github.com/ademuanthony/legalpedia",
	License:         "https://github.com/ademuanthony/legalpedia/blob/master/LICENSE",
...
func (s *Server) MountAssetPaths(pathPrefix string, publicFolder string) {
	...
	FileServer(s.webMux, pathPrefix+"assets", publicFolder+"assets", s.cfg.CacheControlMaxAge)
}
