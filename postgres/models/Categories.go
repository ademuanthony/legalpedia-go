...
var CategoryWhere = struct {
	...
	CategoryId: whereHelperint{field: "\"Categories\".\"CategoryId\""},
	Category:   whereHelpernull_String{field: "\"Categories\".\"Category\""},
}
...
var (
	categoryAllColumns            = []string{"CategoryId", "Category"}
	categoryColumnsWithoutDefault = []string{"CategoryId", "Category"}
...
func FindCategory(ctx context.Context, exec boil.ContextExecutor, categoryId int, selectCols ...string) (*Category, error) {
	...
	query := fmt.Sprintf(
		"select %s from \"Categories\" where \"CategoryId\"=$1", sel,
	)
...
func (o *Category) Delete(ctx context.Context, exec boil.ContextExecutor) (int64, error) {
	...
	sql := "DELETE FROM \"Categories\" WHERE \"CategoryId\"=$1"
...
func CategoryExists(ctx context.Context, exec boil.ContextExecutor, categoryId int) (bool, error) {
	var exists bool
	sql := "select exists(select 1 from \"Categories\" where \"CategoryId\"=$1 limit 1)"
